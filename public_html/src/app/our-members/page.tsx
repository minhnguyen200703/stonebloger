...
const page = () => {
  return (
    <main className="mt-[80px] member-page">
      <section id="our-members" className="text-center py-[40px] px-[40px] lg:px-[135px] w-full">
      ...
      <section id="associate-offices"  className="text-center py-[40px] px-[40px] lg:px-[135px] w-full">
